...
export class HeadlessEngine {
  ...
  private initWorld(): void {
    ...
    const energyPacketSystem = new EnergyPacketSystem(this.resourceState);
    this.world.addSystem(energyPacketSystem);
    ...
    energyPacketSystem.setSiloSystem(this.siloSystem);
