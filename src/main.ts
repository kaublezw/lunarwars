...
const energyPacketSystem = new EnergyPacketSystem(resourceState);
world.addSystem(energyPacketSystem);
world.addSystem(new MatterPacketSystem(resourceState));
const matterDeliverySystem = new MatterDeliverySystem();
world.addSystem(matterDeliverySystem);
world.addSystem(new FerryDockSystem());
const siloSystem = new SiloSystem(terrainData);
world.addSystem(siloSystem);
energyPacketSystem.setSiloSystem(siloSystem);
matterDeliverySystem.setSiloSystem(siloSystem);
